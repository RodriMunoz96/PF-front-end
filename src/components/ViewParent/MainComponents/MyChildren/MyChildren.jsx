...
function MyChildren() {
     ...
     const gradoSeleccionado = grados.find((grado) => grado.id === idGradoSeleccionado);
     ...
     useEffect(() => { dispatch(getAllGrades()) }, [dispatch]);
     ...
     const onChangeGrade = (e) => { setIdGradoSeleccionado(e.target.value) };
